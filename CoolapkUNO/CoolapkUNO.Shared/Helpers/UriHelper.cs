...
namespace CoolapkUNO.Helpers
{
    ...
    public static class UriHelper
    {
        ...
        public static readonly Uri BaseUri = new("https://api.coolapk.com");
        public static readonly Uri Base2Uri = new("https://api2.coolapk.com");
        public static readonly Uri CoolapkUri = new("https://www.coolapk.com");

        public const string LoginUri = "https://account.coolapk.com/auth/loginByCoolapk";

        public static Uri GetUri(string uri) => new(IsUseAPI2 ? Base2Uri : BaseUri, uri);
        ...
        public static Uri GetV1Uri(string uri) => new(BaseUri, uri);
