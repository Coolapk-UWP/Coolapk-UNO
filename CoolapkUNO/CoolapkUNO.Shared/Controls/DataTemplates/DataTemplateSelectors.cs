...
namespace CoolapkUNO.Controls.DataTemplates
{
    ...
    {
        public static Entity GetEntity(JsonElement element, bool isHotFeedPage = false)
        {
        ...
        public static IEnumerable<Entity> GetEntities(JsonElement element)
        {
            yield return GetEntity(element);
        }
    }
}
