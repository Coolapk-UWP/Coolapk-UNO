...
using CoolapkUNO.Helpers.ValueConverters;
using CoolapkUNO.Models.Images;
                        ...
                        switch (node.OriginalName)
                        {
                            ...
                            case "img":
                                ...
                                else
                                {
                                    ...
                                    Paragraph paragraph1 = new Paragraph { TextAlignment = Windows.UI.Xaml.TextAlignment.Center };
